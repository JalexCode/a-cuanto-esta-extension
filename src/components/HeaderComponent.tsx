    ...
    return (
        <header className="navbar p-0 min-h-min max-h-min">
            ...
            <div className="flex m-auto mr-0 gap-3">
                ...
                <label title="Tema" className="hover:cursor-pointer dynamic-fill-color" onClick={() => setDarkMode(!darkMode)}>
                    {darkMode ?
                ...
                <label onClick={handleRefresh} title="Actualizar" className="hover:cursor-pointer dynamic-fill-color">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                ...
                <label title="Acerca de" onClick={() => handlePage('about')} className="hover:cursor-pointer dynamic-fill-color">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
