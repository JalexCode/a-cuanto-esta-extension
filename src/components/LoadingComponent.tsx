    ...
    return (
        <div className="flex flex-col items-center justify-center p-2 transition duration-300 opacity-100">
            <div className="flex items-center justify-center">
                <button type="button" className="inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-white bg-blue-500" disabled={true}>
